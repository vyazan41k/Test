function Sim(sldrId) {
  ...
  if (id) {
    ...
    this.sldrRoot = document.querySelector(".slider-section__slider-box");
  }
...
const span = document.querySelector(".footer-section__cop-span");

const time = new Date();
span.innerHTML = time.getFullYear();
